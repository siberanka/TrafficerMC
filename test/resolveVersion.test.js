...
assert.strictEqual(
  ...
  '26.1',
  '26.2 should resolve to nearest supported 26.1'
)
assert.strictEqual(resolveBotVersion('26.1'), '26.1', '26.1 should resolve to 26.1')
assert.strictEqual(resolveBotVersion('26.0'), '26.1', '26.0 should resolve to nearest 26.1')

// 2. 1.21.x versions
assert.strictEqual(resolveBotVersion('1.21.11'), '1.21.11', '1.21.11 should resolve to 1.21.11')
assert.strictEqual(resolveBotVersion('1.21.10'), '1.21.10', '1.21.10 should resolve to 1.21.10')
...
assert.strictEqual(resolveBotVersion('1.21.7'), '1.21.6', '1.21.7 should resolve to 1.21.6')
assert.strictEqual(resolveBotVersion('1.21.6'), '1.21.6', '1.21.6 should resolve to 1.21.6')
assert.strictEqual(resolveBotVersion('1.21'), '1.21', '1.21 should resolve to 1.21')
